...
const images = {
    "R&D center": "http://localhost/akila/wp-content/uploads/2025/05/hero.png",
    "Logistic Hub": "http://localhost/akila/wp-content/uploads/2025/05/hero.png",
    "Factory A": "http://localhost/akila/wp-content/uploads/2025/05/hero.png",
...
const leftItems = ["R&D center", "Logistic Hub", "Factory A", "Factory B"];
...
function populateList(containerId, items) {
    ...
    items.forEach((item) => {
        ...
        listItem.addEventListener("click", function () {
            ...
            const imageUrl = images[item];

            if (imageUrl) {
                displayedImage.src = imageUrl; // Set image source based on item clicked
...
// Set default image
const displayedImage = document.getElementById("displayedImage");
displayedImage.src = "http://localhost/akila/wp-content/uploads/2025/05/hero.png";

// Add event listeners to chevrons for the left container
document
    .querySelector(".cta__hero__left__container .chevron-up")
    .addEventListener("click", () => {
        scrollList("ctaHeroLeft", "up"); // Scroll up for left container
    });

document
    .querySelector(".cta__hero__left__container .chevron-down")
    .addEventListener("click", () => {
...
document
    .querySelector(".cta__hero__right__container .chevron-up")
    .addEventListener("click", () => {
        scrollList("ctaHeroRight", "up"); // Scroll up for right container
    });

document
    .querySelector(".cta__hero__right__container .chevron-down")
    .addEventListener("click", () => {
...
// AI-EDGE
document.addEventListener("DOMContentLoaded", function () {
  const swiper = new Swiper(".sliders__wrapper.swiper", {
    slidesPerView: "auto",
    spaceBetween: 20,
    loop: true,
    pagination: {
